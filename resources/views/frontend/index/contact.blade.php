...
{{--                    </li>--}}
                    ...
                    @foreach ( getSettingsData(['facebook','youtube','email','freephones','address']) as $settings_data )
                        <li>{{$settings_data}}</li>
                    @endforeach
