...
<form action="{{route('property.update',$data['id'])}}" method="post" enctype="multipart/form-data">
  ...
  <div class="card-body">
    ...
    <div class="form-group">
        ...
        <input name="client" type="client" class="form-control" id="exampleInputClient" placeholder="Enter client" value={{$data['client']}}>
      </div>
    ...
    <div class="form-group">
        ...
        <input name="price" type="price" class="form-control" id="exampleInputprice" placeholder="Enter price" value={{$data['price']}}>
      </div>
